  ...
  return (
    ...
    >
      <Canvas camera={{ position: [0, 0.6, 5.2], fov: 38 }} dpr={[1, 2]}>
        <fog attach="fog" args={["#0d0c09", 7, 14]} />
        {/* Key / fill / rim / bounce lighting, all local. */}
