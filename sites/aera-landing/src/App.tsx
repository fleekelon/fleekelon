...
function LogoMark({ className = "" }: { className?: string }) {
  return (
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      ...
      <span className="font-display text-xs font-semibold tracking-[0.28em]">
        AERA
      </span>
    </span>
  );
...
export default function App() {
  ...
  return (
    <div ref={rootRef} id="top" className="relative bg-black text-aera-white">
      ...
      <section id="model" className="relative overflow-hidden py-28 md:py-36">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-5 text-center md:px-8">
          ...
          <p
            ...
            data-reveal
          >
            Aera One is sculpted around the neural stack — low, silent, and
            precise. Every surface serves the drive.
          </p>
        </div>
      </section>
      ...
      <section id="intelligence" className="relative py-24 md:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-5 text-center md:px-8">
          ...
          <p
            ...
            data-reveal
          >
            Multi-modal perception, continuous learning, and decision latency
            measured in milliseconds — so the cabin stays calm when the world
            isn&apos;t.
          </p>
        </div>
      </section>
      ...
      <section
        id="reserve"
        className="relative border-t border-white/10 py-28 md:py-36"
      >
        <div className="mx-auto max-w-2xl px-5 text-center md:px-8">
          ...
          <p
            ...
            data-reveal
          >
            Limited allocation for founding owners. Leave your email —
            we&apos;ll notify you when reservations open.
          </p>
